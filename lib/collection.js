...
Collection.belongsTo = function(model){
  var belongsToFunctionName = model._name.toLowerCase();
  ...
  this.prototype['_' + belongsToFunctionName] = belongsTo;
  this.prototype[belongsToFunctionName] = null;
}


Collection.hasOne = function(model){
  var keyName = this._name.toLowerCase();
  var hasOneFunctionName = model._name; 
  ...
  this.prototype['_' + hasOneFunctionName] = hasOne;
  this.prototype[hasOneFunctionName] = null;
}

Collection.hasMany = function(model){
  var keyName = this._name.toLowerCase();
  var hasManyFunctionName = lingo.en.pluralize(model._name); 
  ...
  this.prototype['_' + hasManyFunctionName] = hasMany;
  this.prototype[hasManyFunctionName] = [];
}
