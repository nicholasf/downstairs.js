 ...
 **/
var wireToAdapter = function(Model, adapter){
  ...
  reminaingAdapterFunctionNames = _.difference(Object.keys(adapter.__proto__), mandatedCalls);
...
Collection.model = function(name, sql, validations, configurationName){
  ...
  wireToAdapter(Model, configuration.adapter);
