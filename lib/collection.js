...
Collection.model = function model(name, schema, validations, configurationName){
  ...
  if (configurationName){
    ...
    configuration = Downstairs.get(Downstairs.defaultConfiguration);
  }

  if (!configuration){
    throw new Error("Downstairs couldn't identify a configuration for your Collection.\n"
      + "Collection name: " + name
      + ", configurationName: " + configurationName
      + ", Downstairs.configurations: " + util.inspect(Downstairs.configurations)
    );
  }

  if (!configuration.adapter){
    throw new Error("Downstairs cannot find an adapter in your configuration. \n"
